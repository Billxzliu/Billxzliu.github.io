...
Research Topic: Extension of the static analysis framework SVF to graph databases.  
...
- **Computer Vision:** Vision algorithm (YOLO, MASK R-CNN, U-Net, etc.) with robots.
